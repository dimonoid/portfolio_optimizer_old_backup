...
def f(params):
    ...
    print((-(integralPunished), ((params100Sum - 1) ** 2) * 0.0001),
          'sum =', params100Sum)  # , punishment * 0.001))
...
if __name__ == "__main__":
    main(riskToleranceP=3.5, fakePastP=0.05, fakePresentP=0.87, fakeFutureP=0.99)
